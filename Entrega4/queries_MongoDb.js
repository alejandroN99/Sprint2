...
db.restaurantes.find({},{name:1,cuisine:1,borough:1})
...
db.restaurantes.find({},{_id:0,name:1,cuisine:1,borough:1})
...
db.restaurantes.find({},{_id:0,name:1,'address.zipcode':1,borough:1})
...
db.restaurantes.find({$and: [{'cuisine': {$ne: 'American '}},{'grades.grade': 'A'},{'borough': {$ne: 'Brooklyn'}}]}).sort({cuisine:-1})
...
db.restaurantes.find({name:{$regex:/^Wil/}},{restaurante_id:1,name:1,borough:1,cuisine:1})
...
db.restaurantes.find({name:{$regex:/ces$/}},{restaurante_id:1,name:1,borough:1,cuisine:1})
...
db.restaurantes.find({name:{$regex:/Reg/}},{restaurante_id:1,name:1,borough:1,cuisine:1})
...
db.restaurantes.find({$or:[{cuisine: {$in:['seafood','American ','Chinese']}},{name: {$regex:/^Wil/}}]},{restaurante_id:1,name:1,borough:1,cuisine:1})
...
db.restaurantes.find({$and: [{'grades.grade': 'A'},{'grades.score': 11},{'grades.date': ISODate('2014-08-11T00:00:00Z')}]},{restaurante_id:1,name:1,grades:1})
...
db.restaurantes.find({$and: [{'grades.1.grade': 'A'},{'grades.1.score': 9},{'grades.1.date': ISODate('2014-08-11T00:00:00Z')}]},{restaurante_id:1,name:1,grades:1})
...
db.restaurantes.find({},{cuisine:1,borough:1}).sort({cuisine:1},{borough:-1})
